...
class BankAccount 
{   
// instance variables (protecte	d to allow inheriting them)
	/**
...
//constructors
     ...
     */
    public BankAccount(String acct, Customer owner)
    {
        accountID = acct;
        ownersName = owner;	
        balance = 0.00; 
...
// balance changing methods
    ...
    {  
        if (balance >=  amount)
        	...
        	System.out.println("ERROR: You attempted to withdraw $ " + amount + "0 but you only have $ " + balance + "0 in your account");
        }
    }
...
// set: postconditions- these all are used to set new values for the instance variables
     ...
     */
    public void setAccountNumber(String newAcctNumber )
    {
        accountID = newAcctNumber;
    }
